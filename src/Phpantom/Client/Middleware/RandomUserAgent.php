...
class RandomUserAgent implements MiddlewareInterface
{
    ...
    /**
     * @param array $browserFreq
     * @return $this
     */
    public function setBrowserFreq($browserFreq)
    {
        $this->browserFreq = $browserFreq;
        return $this;
    }
     ...
     * @return array
     */
    public function getBrowserFreq()
    {
        return $this->browserFreq;
    }
     ...
     * @return array
     */
    public function getBrowserStrings()
    {
        return $this->browserStrings;
    }

    /**
     * @param array $browserStrings
     */
    public function setBrowserStrings($browserStrings)
    {
        $this->browserStrings = $browserStrings;
    }
    ...
    private function getRandomUserAgent()
    {
        ...
        $rcount = 0;
        $browserType = '';
        $browserFreq = $this->getBrowserFreq();

        foreach ($browserFreq as $v) {
            $max += $v;
        }
        $roll = rand(0, $max);
        ...
        $uaArr = $this->getBrowserStrings()[$browserType];
        shuffle($uaArr);
        $userAgent = $uaArr[0];
        return $userAgent;
    }
